...
def operacion(a,b,sumar_arg):
    print(f'Resultado Sumar_Arg : {sumar_arg(a,b)}')

operacion(4,5,sumar)

#3 PODEMOS RETORNA FUNCION
def retonar_funcion():
    #retornamos una funcion
    return sumar
mi_funcion_retornada=retonar_funcion()
print(f'Funcion Retornada : {mi_funcion_retornada(5,7)}')