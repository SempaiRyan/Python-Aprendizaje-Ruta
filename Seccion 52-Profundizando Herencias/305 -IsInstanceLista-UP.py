...
#METODO INS ISINSTANCE
# isinstance
print('Es entero?', isinstance(10, int))
print('Es cadena?', isinstance('hola', str))
print('Es lista Enteros Ordenadas ?', isinstance(lista_enteros_ordenada, ListaEnterosOrdenada))
print('Es lista Enteros?', isinstance(lista_enteros_ordenada, ListaEnteros))
print('Es lista Ordenadas?', isinstance(lista_enteros_ordenada, ListaOrdenada))
