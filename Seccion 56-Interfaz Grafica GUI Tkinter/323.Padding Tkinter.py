...
def evento4():
    boton4.config(text="Boton 4 Presionado",fg="blue",relief=tk.GROOVE,bg="orange")
...
boton1.grid(row=0,column=0,sticky="NSWE",padx=40, pady=50, ipadx=20,ipady=50,columnspan=2)
